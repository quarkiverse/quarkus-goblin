...
* xref:assault-types.adoc[] -- the six server-side chaos assaults (latency, exception, HTTP status, dependency degradation, response body, response header) plus client-side assaults for outgoing REST Client calls.
