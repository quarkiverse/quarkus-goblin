...
* The only exception is the Dev UI auto-off: once it has switched chaos off, chaos stays off across live reloads of the same dev-mode process, until you switch it on again.
