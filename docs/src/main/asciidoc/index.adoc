...
image::assets/dev-ui-extension-card.png[Goblin card in the Quarkus Dev UI,width=560,align=center]
[.text-center]
...
image::assets/dev-ui-dashboard.png[Goblin Chaos Dashboard,width=720,align=center]
[.text-center]
...
image::assets/dev-ui-history.png[Goblin Assault History,width=720,align=center]
[.text-center]
